...
public class Popolamento {
    public static void main(String[] argsloca) throws SQLException {
        ...
        try {
            ...
            luogoDAO.doSave(new LuogoBean(UUID.fromString("d810ef8f-848d-43c8-b4a0-56fce4d64d13"), "Chiesa Santissima Annunziata", "93 Hallows Plaza", "Angri", "La chiesa sorge sui resti di un antico tempio romando dedicato a Venere.", "https://bit.ly/2VgyLVx"));
