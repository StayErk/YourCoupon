...
<%
    ...
    ArrayList<Bean> beans = (ArrayList<Bean>) o;
            ...
            <%if(beans != null) {
                    ...
                    for (HotelBean b: hotels) { %>
                        <div class="col-lg-4  col-md-6  col-12 mb-3">
                            <div class="card shadow">
                                <img src="<%=b.getImmagine()%>" class="card-img-top img-fluid h-50" alt="<%=b.getNome()%>">
                                <div class="card-body">
                ...
                <%} else if(returnedType.equals("ristoranti")) {
                    ...
                    for (RestaurantBean b : restaurants) {%>
                        <div class="col-lg-4 col-md-6 col-12 mb-3">
                            <div class="card shadow">
                                <img src="<%=b.getImmagine()%>" alt="<%=b.getNome()%>" class="card-img-top img-fluid h-50">
                                <div class="card-body">
                ...
                <%}} else if(beansHash != null) {
                    for(UUID id : beansHash.keySet()) {
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-3">
                            <div class="card shadow">
                                <img src="<%=luogoBean.getImmagine()%>" alt="<%=luogoBean.getNome()%>" class="card-img-top img-fluid h-50">
                                <div class="card-body">
